...
mixin _$User {
  ...
  DateTime? get subscriptionEndsAt => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, avatar: $avatar, subscriptionPlan: $subscriptionPlan, subscriptionEndsAt: $subscriptionEndsAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, avatar,
      subscriptionPlan, subscriptionEndsAt);
...
abstract class _User implements User {
  factory _User(
      ...
      @JsonKey(name: 'subscription_ends_at')
      final DateTime? subscriptionEndsAt}) = _$UserImpl;
...
class _$AuthResponseImpl implements _AuthResponse {
  _$AuthResponseImpl({required this.token, required this.user});
